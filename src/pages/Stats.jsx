    ...
    return (
      <div className="min-h-screen p-40">
        ...
        <div className="border border-royal-blue inline-grid grid-cols-[10fr_2fr] max-w-3xl">
          ...
          {/* Row 1 */}
          <div className="bg-white p-6 border-r border-b border-royal-blue">
            <p className="text-xl font-quantico">Levels Earned</p>
          </div>
          <div className="bg-white p-6 text-right border-b border-royal-blue">
          ...
          <div className="bg-white p-6 border-r border-royal-blue">
            <p className="text-xl font-quantico ">Wild Pokemon Fled</p>
          </div>
          <div className="bg-white p-6 text-right border-royal-blue">
